...
export declare const Labels: <Datum>({ nodes, label, layout, labelsPosition, orientLabel, labelOffset, labelComponent, }: LabelsProps<Datum>) => import("react/jsx-runtime").JSX.Element;
export {};
