...
export declare const Nodes: <Datum>({ nodes, nodeComponent, isInteractive, onMouseEnter, onMouseMove, onMouseLeave, onMouseDown, onMouseUp, onClick, onDoubleClick, setCurrentNode, tooltip, tooltipPosition, tooltipAnchor, margin, }: NodesProps<Datum>) => import("react/jsx-runtime").JSX.Element;
export {};
